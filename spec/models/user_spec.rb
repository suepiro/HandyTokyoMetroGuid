...
describe User do
	...
	describe "whien email is not present" do
		before { @user.email = " " }
		it {should_not be_valid}
	end
	...
	describe "whien name is too long" do
		before { @user.name = "a" * 51}
		it { should_not be_valid}
	end

	describe "when email forat is invalid" do
	...
	describe "whien email format is valid" do
